meses=["Enero","Febrero","Marzo","Abril",";ayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"];
lasemana=["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"]
diassemana=["L","M","W","J","V","S","D"];
...
function escribirdias() {
         ...
         for (i=1;i<7;i++) { //localizar fila
             ...
             for (j=0;j<7;j++) {
                 ...
                 celda.style.backgroundColor="#FAF4D0";
